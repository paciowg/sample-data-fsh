...
* item[=].answer.valueCoding = $LOINC#LA25855-0 "The pain is moderate at the moment."
...
* item[=].answer.valueCoding = $LOINC#LA25860-0 "I can look after myself normally but it causes extra pain."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 1

* item[+].linkId = "ndi-3"
* item[=].text = "Lifting" // LOINC#82229-6
* item[=].answer.valueCoding = $LOINC#LA25867-5 "Pain prevents me lifting heavy weights off the floor, but I can manage if they are conveniently placed, for example on a table."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-4"
* item[=].text = "Reading" // LOINC#82230-4
* item[=].answer.valueCoding = $LOINC#LA25873-3 "I can read as much as I want with moderate pain in my neck."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-5"
* item[=].text = "Headaches" // LOINC#82231-2
* item[=].answer.valueCoding = $LOINC#LA26367-5 "I have moderate headaches, which come frequently."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 3

* item[+].linkId = "ndi-6"
* item[=].text = "Concentration" // LOINC#82232-0
* item[=].answer.valueCoding = $LOINC#LA25880-8 "I have a fair degree of difficulty in concentrating when I want to."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-7"
* item[=].text = "Work" // LOINC#82233-8
* item[=].answer.valueCoding = $LOINC#LA25886-5 "I can do most of my usual work, but no more."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-8"
* item[=].text = "Driving" // LOINC#82234-6
* item[=].answer.valueCoding = $LOINC#LA25892-3 "I can drive my car as long as I want with moderate pain in my neck."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-9"
* item[=].text = "Sleeping" // LOINC#82235-3
* item[=].answer.valueCoding = $LOINC#LA25898-0 "My sleep is mildly disturbed (1-2 hrs sleepless)."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2

* item[+].linkId = "ndi-10"
* item[=].text = "Recreation" // LOINC#82236-1
* item[=].answer.valueCoding = $LOINC#LA25904-6 "I am able to engage in most, but not all of my usual recreation activities because of pain in my neck."
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item[=].answer.valueCoding.extension.valueDecimal = 2
