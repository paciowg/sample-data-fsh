...
Instance: wilmamarina01-AllergyACE
InstanceOf: AllergyIntolerance
Usage: #example
Description: "Wilma Marina allergy to ACE inhibitors"
...
* patient = Reference(Patient/patient-wilmamarina01)
* clinicalStatus = $allergyintolerance-clinical#active
* verificationStatus = $allergyintolerance-verification#confirmed
* category = #medication
* criticality = #high
* lastOccurrence = "2011-10"
* asserter = Reference(Patient/patient-wilmamarina01)
