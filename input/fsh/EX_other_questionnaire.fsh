...
* item[0].linkId = "97479"
* item[=].code = $loinc#52731-7 "Repetition of three words # [BIMS]"
* item[=].prefix = "C0200"
...
* item[=].item[=].code = $loinc#52732-5 "Temporal orientation - current year [BIMS]"
...
* item[=].item[=].code = $loinc#52733-3 "Temporal orientation - current month [BIMS]"
...
* item[=].item[=].code = $loinc#54609-3 "Temporal orientation - current day of the week [BIMS]"
...
* item[=].item[=].code = $loinc#52735-8 "Recall - sock [BIMS]"
...
* item[=].item[=].code = $loinc#52736-6 "Recall - blue [BIMS]"
...
* item[=].item[=].code = $loinc#52737-4 "Recall - bed [BIMS]"
