...
* section[+].entry[0] = Reference(Condition/betsysmith-johnson01-AnemiaDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-Constipation)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-DepressionDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-DiabetesDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-DressingConcern)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-HeartDiseaseDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-HemiparesisDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-Hyperlipidemia)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-HypertensionDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-KidneyDisease)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-NauseaAndVomiting)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-StrokeDiagnosis)
* section[=].entry[+] = Reference(Condition/betsysmith-johnson01-UndressingConcern)
