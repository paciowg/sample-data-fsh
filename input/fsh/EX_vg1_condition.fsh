...
* meta.profile = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition-encounter-diagnosis" // US Core vs. PFE-condition
...
// * bodySite = $sct#40927001 "Both lower legs" // Just need right leg code.
// * bodySite.text = "Entire Right Leg"
...
* subject = Reference(Patient/patient-VioletGartner01) "Violet Gartner"
// * bodySite = $sct#368209003 "Right upper arm" // Is this the right humerus?
