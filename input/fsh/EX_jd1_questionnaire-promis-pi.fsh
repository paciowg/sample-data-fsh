...
* code = $LOINC#90973-9 "PROMIS short form - pain interference 6a - version 1.0"
* subjectType[+] = #Patient

* item[+].linkId = "pi6a-1"
* item[=].text = "In the past 7 days: How much did pain interfere with your day to day activities?"
* item[=].type = #choice
* item[=].code = $LOINC#61758-9
...
* item[+].linkId = "tscore"
* item[=].type = #decimal
* item[=].code = $LOINC#77865-4 "PROMIS pain interference - version 1.0 Tscore"
...
* item[+].linkId = "pi6a-1"
* item[=].text = "In the past 7 days: How much did pain interfere with your day to day activities?"
* item[=].answer.valueCoding = $LOINC#LA13863-8 "A little bit"
...
* item[+].linkId = "pi6a-3"
* item[=].text = "In the past 7 days: How much did pain interfere with your ability to participate in social activities?"
* item[=].answer.valueCoding = $LOINC#LA13909-9 "Somewhat"
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
...
* code = $LOINC#89923-7 "PROMIS item bank - pain interference - version 1.1"
* subjectType[+] = #Patient
...
* item[+].linkId = "tscore"
* item[=].type = #decimal
* item[=].code = $LOINC#89924-5 "PROMIS pain interference - version 1.1 Tscore"
...
* item[=].extension[=].valueDecimal = 41.6
* item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/maxValue"
* item[=].extension[=].valueDecimal = 69.3
...
* item[=].answer.valueCoding = $LOINC#LA13902-4 "Quite a bit"
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
...
* item[=].answer.valueCoding = $LOINC#LA13914-9 "Very much"
* item[=].answer.valueCoding.extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
