...
Instance: wilmamarina01-lipid-panel-01
InstanceOf: DiagnosticReport
Usage: #example
Description: "Wilma Marina's Diagnostic Report - Lipid Panel"
// * meta.profile = "http://hl7.org/fhir/StructureDefinition/lipids-diagnostic-report"
// * contained[0] = wilmamarina01-observation-cholesterol-01
// * contained[+] = wilmamarina01-observation-triglyceride-01
// * contained[+] = wilmamarina01-observation-hdl-01
// * contained[+] = wilmamarina01-observation-ldl-01
...
* performer = Reference(Organization/org-Michigan-Primary-Health-Care-A)
* result[0] = Reference(wilmamarina01-observation-cholesterol-01)
* result[+] = Reference(wilmamarina01-observation-triglyceride-01)
* result[+] = Reference(wilmamarina01-observation-hdl-01)
* result[+] = Reference(wilmamarina01-observation-ldl-01)
...
Instance: wilmamarina01-observation-cholesterol-01
InstanceOf: Observation
Usage: #Example
Description: "Wilma Marina's Diagnostic Report - Cholesterol"
* status = #final
...
Instance: wilmamarina01-observation-triglyceride-01
InstanceOf: Observation
Usage: #Example
Description: "Wilma Marina's Diagnostic Report - Triglyceride"
* status = #final
* category = $observation-category#laboratory "Laboratory"
...
Instance: wilmamarina01-observation-hdl-01
InstanceOf: Observation
Usage: #Example
Description: "Wilma Marina's Diagnostic Report - HDL"
* status = #final
* category = $observation-category#laboratory "Laboratory"
...
Instance: wilmamarina01-observation-ldl-01
InstanceOf: Observation
Usage: #Example
Description: "Wilma Marina's Diagnostic Report - LDL"
* status = #final
* category = $observation-category#laboratory "Laboratory"
