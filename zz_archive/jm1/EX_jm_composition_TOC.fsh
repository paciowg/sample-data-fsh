...
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtAcetaminophenSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtAlprazolamSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtAtorvastatinSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtDexamethasoneSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtGabapentinSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtMetoclopramideSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtMetoprololSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtOndansetronSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtOralMorphineSNFdischarge)
* section[=].entry[+] = Reference(MedicationStatement/jenny-mosley-smp-medstmtPolyethyleneGlycolSNFdischarge)
* section[+].title = "List of problem conditions and observations for Jenny Mosley"
* section[=].code = $loinc#18776-5
* section[=].text.status = #additional
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">List of problem conditions and observations for Jenny Mosley</div>"
